...
class BannerCarouselOdoo extends StatefulWidget {
  ...
  /// ```
  const BannerCarouselOdoo.fullScreen({
    super.key,
    this.banners,
    this.height = 150,
    this.borderRadius = 0,
...
class _BannerCarouselState extends State<BannerCarouselOdoo> {
  late int _page;
